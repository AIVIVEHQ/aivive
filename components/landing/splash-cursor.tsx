...
export function SplashCursor({
  ...
  useEffect(() => {
    ...
    class Material {
      vertexShader: any; fragmentShaderSource: any; programs: any[] = []; activeProgram: any = null; uniforms: any[] = [];
      constructor(vertexShader: any, fragmentShaderSource: any) { this.vertexShader = vertexShader; this.fragmentShaderSource = fragmentShaderSource; }
    ...
    class Program {
      ...
      constructor(vertexShader: any, fragmentShader: any) { this.program = createProgram(vertexShader, fragmentShader); this.uniforms = getUniforms(this.program); }
