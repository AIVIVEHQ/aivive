  ...
  return (
    <section ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div
          className={`relative border border-primary/20 transition-all duration-1000 hover:border-primary/40 ${
        ...
        >
          ...
          <div 
            ...
            style={{
              background: `radial-gradient(600px circle at ${mousePosition.x}% ${mousePosition.y}%, oklch(0.902 0.152 174.5 / 0.2), transparent 40%)`
            }}
          />
